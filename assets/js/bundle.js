...
/* harmony import */ var filterizr__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! filterizr */ "./node_modules/filterizr/dist/filterizr.min.js");
/* harmony import */ var filterizr__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(filterizr__WEBPACK_IMPORTED_MODULE_3__);
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('[data-magnetic]').each(function(){new magnetic__WEBPACK_IMPORTED_MODULE_2__["default"](this);});//scroll
var scroll=new locomotive_scroll__WEBPACK_IMPORTED_MODULE_4__["default"]({el:document.querySelector('[data-scroll-container]'),smooth:true,smoothMobile:true});//Menu
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.button').on('click',function(){jquery__WEBPACK_IMPORTED_MODULE_0___default()('.button').toggleClass('-menu-open');jquery__WEBPACK_IMPORTED_MODULE_0___default()('.menu__navbar').toggleClass('active');});jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scroll(function(){var height=jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop();if(height>0){jquery__WEBPACK_IMPORTED_MODULE_0___default()('.button').removeClass('-menu-open');jquery__WEBPACK_IMPORTED_MODULE_0___default()('.menu__navbar').removeClass('active');}});jquery__WEBPACK_IMPORTED_MODULE_0___default()('.projects__menu li').on('click',function(){jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).siblings().removeClass('active');jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass('active');});//Gallery
imagesloaded__WEBPACK_IMPORTED_MODULE_5___default()('.projects__gallery');filterizr__WEBPACK_IMPORTED_MODULE_3___default.a.installAsJQueryPlugin(jquery__WEBPACK_IMPORTED_MODULE_0___default.a);jquery__WEBPACK_IMPORTED_MODULE_0___default()('.projects__gallery').filterizr({animationDuration:0.4,callbacks:{onFilteringStart:function onFilteringStart(){},onFilteringEnd:function onFilteringEnd(){},onShufflingStart:function onShufflingStart(){},onShufflingEnd:function onShufflingEnd(){},onSortingStart:function onSortingStart(){},onSortingEnd:function onSortingEnd(){}},delay:0,delayMode:'progressive',easing:'ease-out',filter:'all',filterOutCss:{opacity:0,transform:'scale(0.5)'},filterInCss:{opacity:1,transform:'scale(1)'},gutterPixels:20,layout:'sameWidth',selector:'.projects__gallery',setupControls:true});// var mobile = window.matchMedia("screen and (max-width: 1240px)")
// mobile.addListener( function(mobile) {
//   if (mobile.matches) {
//    LocomotiveScroll.remove();
//   } else {
//   }
// });
